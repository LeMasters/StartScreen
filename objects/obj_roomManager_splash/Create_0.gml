...
graphic = instance_create_layer(1000,450,"Instances",obj_nyanCat);
graphic.image_xscale = -0.5;
graphic.image_yscale = 0.5;
graphic.speed = 2.2;
graphic.direction = 180;

titles = instance_create_layer(room_width,room_height,"Instances",obj_titles);
titles.visible = false;
titles.image_xscale = 0.5;
titles.image_yscale = 0.5;
